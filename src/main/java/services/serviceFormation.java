...
public class serviceFormation implements iservice<formation> {
    ...
    public void ajouter(formation formation) throws SQLException {
        ...
        preparedStatement.setDate(6, new java.sql.Date(formation.getDate_Deb().getTime()));
        preparedStatement.setDate(7, new java.sql.Date(formation.getDate_Fin().getTime()));
    ...
    public void modifier(formation formation) throws SQLException {
        ...
        try (PreparedStatement pre = connection.prepareStatement(req)) {
            ...
            pre.setDate(5, new java.sql.Date(formation.getDate_Deb().getTime()));
            pre.setDate(6, new java.sql.Date(formation.getDate_Fin().getTime()));
